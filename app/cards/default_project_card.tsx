...
export default function DefaultCard({url, imgUrl, title, description} 
    ...
    return ( 
        ...
        <div className="flex flex-col dark:bg-neutral-800 bg-neutral-100 rounded-xl p-2 hover:scale-110 justify-start hover:cursor-pointer" onClick={ () => window.open(url)} >
